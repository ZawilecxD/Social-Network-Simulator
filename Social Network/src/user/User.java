...
//	private Context<Object> context;
	...
	/**
	 * Cechy charakteru definiuj�ce danego user'a i jego ch�� do wykonywania r�nych akcji
	 */
	private @Getter UserCharacteristics characteristics;
	
	/**
	 * Ustatalany ka�dorazowo przy zalogowaniu do servisu, powiedzmy �e ma warto�ci mi�dzy 0.0-10.0 
	 * gdzie 10.0 to super nastawienie i ch�� kontaktu z innymi userami
	 */
